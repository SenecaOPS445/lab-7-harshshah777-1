...
class Time:
    ...
    def __repr__(self):
        """Return a string representation of the time object for interactive shell."""
        return f'{self.hour:02d}.{self.minute:02d}.{self.second:02d}'
...
def change_time(t, seconds):
    """Add seconds to time object (t)"""
    total_seconds = time_to_sec(t) + seconds
    new_time = sec_to_time(total_seconds)
    t.hour, t.minute, t.second = new_time.hour, new_time.minute, new_time.second
